...
export const leads: Lead[] = [
  {
    ...
    notes: [],
    documents: [
      { id: "d1", name: "Stromrechnung_2025.pdf", kind: "rechnung", size: "284 KB", uploadedAt: "2026-06-14T09:22:00" },
    ],
    emails: [
  ...
  },
  {
    ...
    emails: [
      { id: "e1", subject: "Ihre Anfrage für Gewerbestrom", from: "noreply@energieclever.de", to: "info@baeckerei-krueger.de", date: "2026-06-13T15:43:00", direction: "out", preview: "Vielen Dank, wir prüfen sofort…" },
      { id: "e2", subject: "Ihr persönliches Gewerbestrom-Angebot", from: "daniel.kraus@energieclever.de", to: "info@baeckerei-krueger.de", date: "2026-06-13T18:15:00", direction: "out", preview: "Anbei finden Sie Ihr persönliches Angebot mit 24-Monate-Preisgarantie…" },
      { id: "e3", subject: "Re: Ihr persönliches Gewerbestrom-Angebot", from: "info@baeckerei-krueger.de", to: "daniel.kraus@energieclever.de", date: "2026-06-14T08:32:00", direction: "in", preview: "Vielen Dank, sieht sehr gut aus. Eine Frage zur Kündigungsfrist…" },
    ],
    offers: [
  ...
  },
  {
    ...
    notes: [],
    documents: [
      { id: "d1", name: "Gasrechnung_2025.pdf", kind: "rechnung", size: "256 KB", uploadedAt: "2026-06-12T11:19:00" },
      { id: "d2", name: "Vertrag_Eprimo_Gas.pdf", kind: "vertrag", size: "324 KB", uploadedAt: "2026-06-14T09:00:00" },
    ],
    emails: [],
    offers: [
...
export interface Employee { id: string; name: string; role: Role; email: string; closed: number; open: number; conversion: number; active: boolean; }

export const employees: Employee[] = [
  { id: "u1", name: "Sarah Becker", role: "admin", email: "sarah.becker@energieclever.de", closed: 18, open: 12, conversion: 41, active: true },
  { id: "u2", name: "Daniel Kraus", role: "manager", email: "daniel.kraus@energieclever.de", closed: 14, open: 9, conversion: 38, active: true },
  { id: "u3", name: "Mira Aydin", role: "mitarbeiter", email: "mira.aydin@energieclever.de", closed: 11, open: 7, conversion: 34, active: true },
  { id: "u4", name: "Jonas Vetter", role: "mitarbeiter", email: "jonas.vetter@energieclever.de", closed: 6, open: 4, conversion: 28, active: true },
  { id: "u5", name: "Lena Fuchs", role: "mitarbeiter", email: "lena.fuchs@energieclever.de", closed: 0, open: 0, conversion: 0, active: false },
];

export const roleLabel: Record<Role, string> = { admin: "Admin", manager: "Manager", mitarbeiter: "Mitarbeiter" };

export interface Provider { id: string; name: string; type: "strom" | "gas" | "beide"; tariffsCount: number; rating: number; partner: boolean; }
export const providers: Provider[] = [
  ...
  { id: "p9", name: "Stadtwerke München", type: "beide", tariffsCount: 7, rating: 4.3, partner: false },
];

export interface Tariff { id: string; provider: string; name: string; type: "strom" | "gas"; segment: "privat" | "gewerbe"; pricePerKwh: number; basePrice: number; duration: number; priceGuarantee: number; eco: boolean; }
export const tariffs: Tariff[] = [
  { id: "t1", provider: "E.ON", name: "PrivatStrom Plus", type: "strom", segment: "privat", pricePerKwh: 28.4, basePrice: 11.9, duration: 12, priceGuarantee: 12, eco: false },
  { id: "t2", provider: "EnBW", name: "Gewerbestrom 24 Fix", type: "strom", segment: "gewerbe", pricePerKwh: 24.1, basePrice: 14.5, duration: 24, priceGuarantee: 24, eco: false },
  { id: "t3", provider: "Yello", name: "Klassik Strom 12", type: "strom", segment: "privat", pricePerKwh: 27.8, basePrice: 10.5, duration: 12, priceGuarantee: 12, eco: false },
  { id: "t4", provider: "LichtBlick", name: "ÖkoStrom Premium", type: "strom", segment: "privat", pricePerKwh: 30.2, basePrice: 12.9, duration: 12, priceGuarantee: 12, eco: true },
  { id: "t5", provider: "Naturstrom", name: "Bio-Erdgas Komfort", type: "gas", segment: "privat", pricePerKwh: 11.4, basePrice: 9.9, duration: 24, priceGuarantee: 24, eco: true },
  { id: "t6", provider: "Vattenfall", name: "EasyGas 24", type: "gas", segment: "privat", pricePerKwh: 9.8, basePrice: 8.9, duration: 24, priceGuarantee: 24, eco: false },
  { id: "t7", provider: "eprimo", name: "Gas Direkt 12", type: "gas", segment: "privat", pricePerKwh: 9.1, basePrice: 8.0, duration: 12, priceGuarantee: 12, eco: false },
  { id: "t8", provider: "EnBW", name: "Gewerbegas Fix 24", type: "gas", segment: "gewerbe", pricePerKwh: 8.6, basePrice: 12.5, duration: 24, priceGuarantee: 24, eco: false },
];

export interface EmailTemplate { id: string; name: string; subject: string; trigger: string; lastEdited: string; active: boolean; }
export const emailTemplates: EmailTemplate[] = [
  { id: "et1", name: "Anfrage-Bestätigung", subject: "Ihre Anfrage für Strom/Gas ist eingegangen", trigger: "Lead erstellt", lastEdited: "2026-05-12", active: true },
  { id: "et2", name: "Rückfrage Jahresrechnung", subject: "Uns fehlt noch Ihre letzte Jahresrechnung", trigger: "Status: Rückfrage offen", lastEdited: "2026-04-28", active: true },
  { id: "et3", name: "Angebot versendet", subject: "Ihr persönliches Strom-/Gasangebot ist da", trigger: "Status: Angebot gesendet", lastEdited: "2026-05-30", active: true },
  { id: "et4", name: "Vertrag zur Unterschrift", subject: "Hier können Sie Ihr Angebot bestätigen", trigger: "Status: Vertrag gesendet", lastEdited: "2026-06-02", active: true },
  { id: "et5", name: "Erinnerung Nicht erreichbar", subject: "Wir versuchen, Sie zu erreichen", trigger: "48 Std. ohne Reaktion", lastEdited: "2026-03-19", active: true },
  { id: "et6", name: "Wiedervorlage", subject: "Wir melden uns wie vereinbart zurück", trigger: "Wiedervorlage-Datum erreicht", lastEdited: "2026-05-22", active: false },
];

...
const mainNav: NavItem[] = [
  {
    ...
    dropdown: {
      title: "Strom",
      mainLinks: [
        { label: "Unsere Stromtarife", to: "/angebot" },
        { label: "Haushaltsstrom", to: "/angebot" },
        { label: "Ökostrom 100 %", to: "/angebot" },
        { label: "Autostrom für E-Autos", to: "/angebot" },
        { label: "Wärmestrom", to: "/angebot" },
      ],
      secondaryLinks: [
        { label: "Anbieter wechseln – so geht's", to: "/faq" },
        { label: "Alles über Strom – Ratgeber", to: "/faq" },
      ],
      articles: [
        { to: "/faq", title: "Strompreis 2026: Was Haushalte jetzt wissen müssen", image: imgAutostrom },
        { to: "/faq", title: "Ökostrom erkennen: Echte Labels im Vergleich", image: imgSolar },
        { to: "/faq", title: "E-Auto laden zuhause: Der günstigste Weg", image: imgWaerme },
      ],
    },
  },
  {
    ...
    dropdown: {
      title: "Gas",
      mainLinks: [
        { label: "Unsere Gastarife", to: "/angebot" },
        { label: "Erdgas Privat", to: "/angebot" },
        { label: "Bio-Erdgas", to: "/angebot" },
        { label: "Gas für Gewerbe", to: "/angebot" },
      ],
      secondaryLinks: [
        { label: "Gasanbieter wechseln", to: "/faq" },
        { label: "Alles über Gas – Ratgeber", to: "/faq" },
      ],
      articles: [
        { to: "/faq", title: "Gaspreise 2026: Prognose & Tipps zum Sparen", image: imgWaerme },
        { to: "/faq", title: "Heizkosten senken: 7 schnelle Maßnahmen", image: imgAutostrom },
      ],
    },
  },
  {
    ...
    dropdown: {
      title: "Strom + Gas",
      mainLinks: [
        { label: "Komfort-Bundle", to: "/angebot" },
        { label: "Familien-Tarif", to: "/angebot" },
        { label: "Öko-Komplett", to: "/angebot" },
        { label: "Bundle berechnen", to: "/angebot" },
      ],
      secondaryLinks: [{ label: "Doppel-Bonus erklärt", to: "/faq" }],
      articles: [
        { to: "/faq", title: "Strom & Gas bündeln: Wann sich der Doppel-Bonus lohnt", image: imgSolar },
        { to: "/faq", title: "Ein Vertrag statt zwei: So einfach geht der Wechsel", image: imgAutostrom },
      ],
    },
  },
  {
    ...
    dropdown: {
      ...
      mainLinks: [
        { label: "Unsere Energielösungen", to: "/kontakt" },
        { label: "Solaranlage", to: "/kontakt" },
        { label: "Stromspeicher", to: "/kontakt" },
        { label: "Wärmepumpe", to: "/kontakt" },
      ],
      secondaryLinks: [
        { label: "Gewerbe Photovoltaik", to: "/kontakt" },
        { label: "Alles über Solar – Ratgeber", to: "/faq" },
      ],
      articles: [
        { to: "/faq", title: "Solaranlage-Kosten 2026: Alle Infos auf einen Blick", image: imgSolar },
        { to: "/faq", title: "Solaranlagen Installation – so geht's", image: imgWaerme },
        { to: "/faq", title: "Förderungen & Zuschüsse für Solaranlagen 2026", image: imgAutostrom },
      ],
    },
  },
  { to: "/faq", label: "Wissen" },
  {
    ...
    dropdown: {
      ...
      mainLinks: [
        ...
        { label: "Wechsel-Service", to: "/kontakt" },
        { label: "Dokumente & Verträge", to: "/kontakt" },
      ],
      secondaryLinks: [{ label: "Freunde werben & profitieren", to: "/kontakt" }],
      articles: [
        { to: "/faq", title: "So einfach läuft dein Anbieterwechsel mit uns", image: imgAutostrom },
        { to: "/faq", title: "Diese Unterlagen brauchst du beim Wechsel", image: imgWaerme },
      ],
    },
  },
  {

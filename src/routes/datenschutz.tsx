...
export const Route = createFileRoute("/datenschutz")({
  ...
  component: () => (
    <StaticPage title="Datenschutzerklärung" lead="Wir verarbeiten Ihre Daten ausschließlich gemäß DSGVO.">
      ...
      <p className="text-xs text-muted-foreground">Diese Seite ist ein Platzhalter und ersetzt keine individuelle Rechtsberatung.</p>
    </StaticPage>
  ),
});

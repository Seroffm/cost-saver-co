...
import { HelpCircle, ArrowRight, MessageCircleQuestion, ShieldCheck, Zap, FileText, Euro, Clock } from "lucide-react";
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 md:py-20">
        <div className="space-y-12">
          {categories.map((cat, i) => (
            <motion.div key={cat.title} {...fadeUp} transition={{ ...fadeUp.transition, delay: i * 0.03 }}>
              ...
              <Accordion type="single" collapsible className="space-y-3">
                {cat.faqs.map((f, idx) => (
                  ...
                  >
                    ...
                    <AccordionContent className="pb-5 pl-8 text-muted-foreground">{f.a}</AccordionContent>
                  </AccordionItem>
                ))}
              </Accordion>
            </motion.div>

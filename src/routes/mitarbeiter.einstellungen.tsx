          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input defaultValue="Becker" />
              </div>
            </div>
            <div className="space-y-1.5">
              <Label>E-Mail</Label>
              <Input defaultValue="sarah.becker@energieclever.de" />
            </div>
            <div className="space-y-1.5">
              <Label>Telefon</Label>
              <Input defaultValue="+49 221 1234567" />
            </div>
              ...
              <tbody className="divide-y">
                {[
                  ...
                  },
                  {
                    name: "Jonas Vogt",
                    role: "Berater",
                    email: "jonas.vogt@energieclever.de",
                    status: "Eingeladen",
                  },
                ].map((u) => (
                  <tr key={u.email}>
                    ...
                    <td className="py-3">
                      <span
                        className={`rounded px-2 py-0.5 text-xs ${u.status === "Aktiv" ? "bg-emerald-500/15 text-emerald-700" : "bg-amber-500/15 text-amber-700"}`}
                      >
                        {u.status}
                      </span>
                    </td>

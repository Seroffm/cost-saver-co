...
import {
  Users, ShieldCheck, Heart, Award, Sparkles, ArrowRight,
  Handshake, Leaf, Target, Compass, CheckCircle2, MapPin,
} from "lucide-react";
      ...
      <section className="border-y border-border bg-muted/30">
        <div className="mx-auto max-w-6xl px-4 py-20 md:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">Vier Werte, die wir jeden Tag in jedem Telefonat ernst nehmen.</p>
          </div>
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="mx-auto max-w-4xl px-4 py-20 md:py-24">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold text-primary md:text-4xl">Sieben Jahre EnergieClever</h2>
          </div>
